...
#./node_modules/.bin/electron-packager ./server NTK --platform=linux --arch=x64 --version=0.35.1 --overwrite --out=packaged --icon=server/icons/icon.icns --app-version=1.0.0
